...
import ma.kayas.cro.ykcrf.domain.Region;
import ma.kayas.cro.ykcrf.repository.RegionRepository;
import ma.kayas.cro.ykcrf.service.RegionService;
import ma.kayas.cro.ykcrf.service.dto.RegionDTO;
import ma.kayas.cro.ykcrf.service.mapper.RegionMapper;
...
public class RegionResourceIntTest {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getTitre()).isEqualTo(DEFAULT_TITRE);
    }
    ...
    public void updateRegion() throws Exception {
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getTitre()).isEqualTo(UPDATED_TITRE);
    }
