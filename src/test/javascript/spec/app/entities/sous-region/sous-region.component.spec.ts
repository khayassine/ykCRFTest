...
import { SousRegionComponent } from 'app/entities/sous-region/sous-region.component';
...
describe('Component Tests', () => {
    describe('SousRegion Management Component', () => {
        let comp: SousRegionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SousRegionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sousRegions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
