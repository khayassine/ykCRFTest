...
describe('Service Tests', () => {
    describe('Centre Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Centre(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Centre', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        titre: 'BBBBBB',
            ...
            it('should return a list of Centre', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        titre: 'BBBBBB',
            ...
            it('should delete a Centre', async () => {
