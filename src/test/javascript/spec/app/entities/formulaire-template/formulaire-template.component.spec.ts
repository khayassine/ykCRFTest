...
import { FormulaireTemplateComponent } from 'app/entities/formulaire-template/formulaire-template.component';
...
describe('Component Tests', () => {
    describe('FormulaireTemplate Management Component', () => {
        let comp: FormulaireTemplateComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FormulaireTemplateComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new FormulaireTemplate(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.formulaireTemplates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
