...
import { FichePatientComponent } from 'app/entities/fiche-patient/fiche-patient.component';
...
describe('Component Tests', () => {
    describe('FichePatient Management Component', () => {
        let comp: FichePatientComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FichePatientComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.fichePatients[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
